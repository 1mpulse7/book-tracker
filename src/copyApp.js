// code provided by udacity, keep as reference point for creating book components
    ...
    return (
      ...
      <div className="list-books-title"><h1>My Book Tracker</h1></div>
        <section className="bookshelf">
          <CurrentlyReading booksReading={this.state.books.filter(book => book.readState === 'CurrentlyReading')}/>
          <WillRead booksToRead={this.state.books.filter(book => book.readState === 'wantToRead')}/>
...
.filter(book => book.readState === 'CurrentlyReading')
.filter(book => book.readState === 'wantToRead')
.filter(book => book.readState === 'read')
